        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="#"><img src="<?=base_url();?>public/images/logo.jpg" alt=""></a>
                </div>
                <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                      <div class="navigation">
                        <div id="navigation">
                            <ul>
                                <li class="active"><a href="<?php echo base_url('siswa');?>" title="Beranda">Beranda</a></li>
                                ...
                                <li class="active"><a href="<?php echo base_url('siswa/pesan');?>" title="Pesan">Kirim Pesan</a></li>
                                <li class="active"><a href="<?php echo site_url('siswa/bantuan');?>" title="Bantuan">Bantuan</a></li>
                                <li class="has-sub"><a href="#" title=""><?= $this->session->userdata('siswa_username');?></a>
                                    <ul>
                                        <li><a href="<?=site_url('login/logout');?>" title="Logout" onclick="return confirm('Apakah anda yakin ingin keluar ?')"> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
