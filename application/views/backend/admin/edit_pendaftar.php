	...
	<div class="panel panel-container" style="padding: 50px">
		<div class="bootstrap-table">
			...
			<form class='form-horizontal row-border' action='<?=site_url("admin/update_pendaftar");?>' method='post' target="_parent">
				...
				<center>
					...
					<a href="<?=site_url('admin/data_pendaftar');?>" class='btn btn-sm btn-primary' >Cancel</a>
				</center>
			</form>
			</div>
		</div>		
