<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="<?=site_url('admin/nilai')?>"><?=$title;?></a></li>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form method="post" id="form" action="<?=site_url('admin/save_nilai')?>">
					...
					<div class="btn-group">
						...
						<a href="<?=site_url('admin/nilai')?>" type="button" class="btn btn-default">Kembali</a>
					</div>
				</form>
			</div>
		</div>
