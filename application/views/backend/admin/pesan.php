            ...
            <tbody>
                ...
                <tr>
        			...
        			<td>
                        ...
                        <a class='btn btn-sm btn-danger' href="<?php echo site_url('admin/del_pesan/'.$row['id_pesan']);?>" onclick="return confirm('Apakah anda yakin ingin menghapus pesan ?')"><i class="entypo-trash"></i>Hapus</a>
        			</td>
                </tr>
            </tbody>
                <?php } ?>
