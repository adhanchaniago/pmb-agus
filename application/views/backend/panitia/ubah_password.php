<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="panel panel-container" style="padding: 50px">
		<div class="bootstrap-table">
			...
			<form class='form-horizontal row-border' action='<?=site_url("panitia/update_password");?>' method='post' target="_parent">
				<div class='form-group'>
					<label class='col-md-2 control-label'>Username</label>
					<div class='col-md-10'>
						<input type='text' name='username' class='form-control' value="<?=$this->session->userdata('panitia_username');?>" readonly='readonly'/>
					</div>
				</div>
				<div class='form-group'>
